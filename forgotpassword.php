            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action='processing' method = 'post' style = 'border:2px solid #fff;'>
                  ...
                  <h5 class="fw-normal fs-1 mb-3 pb-3" style="letter-spacing: 1px;">Forgot My Password</h5>
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <label class="form-label fs-5" placeholder='Email' for="form2Example17">Email address</label>
                  </div>

                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg btn-block p-2 fs-3" name = 'forgetsendmail' type="submit" style = 'border:none;background:#fe2121;'>Sent Verification Code</button>
                  </div>
