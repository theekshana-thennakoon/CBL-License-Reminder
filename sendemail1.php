	...
	if ($result->num_rows > 0){
		while($row = $result->fetch_assoc()){
            ...
            if (isset($to)){
                ...
                echo $send_mail_result = smtp_mailer($to,$email_subject,$email_body);
                if ($send_mail_result){
                    if ($different <= 0){
...
function smtp_mailer($to,$subject, $msg){
	...
	$mail->IsHTML(true);
	$mail->CharSet = 'UTF-8';
	$mail->Username = "milans.pf@cbllk.com";
	$mail->Password = "Reminder@123";
	$mail->SetFrom("milans.pf@cbllk.com");
